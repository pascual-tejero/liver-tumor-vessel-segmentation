...
Selecting a suitable truncation threshold
"""
...
# -200 to 200 threshold for liver: 99.49% for training set, 99...0% for test set
# -200 to 200 threshold for tumour: 99.95% for training set, 99.45% for test set
